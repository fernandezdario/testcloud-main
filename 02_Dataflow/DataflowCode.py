...
def edemData(output_table):
    ...
    with beam.Pipeline(options=options) as p:
        ...
        data = (
            ...
            p | "Read messages from PubSub" >>  beam.io.ReadFromPubSub(subscription=f"projects/serverless-dario/subscriptions/{output_table}-sub", with_attributes=True)
        ...
        (data | "Write to BigQuery" >>  beam.io.WriteToBigQuery(
            table = f"serverless-dario:edemDataset.{output_table}",
            schema = schema,
        ...
        (data 
            ...
            | "WriteToPubSub" >>  beam.io.WriteToPubSub(topic="projects/serverless-dario/topics/iotToCloudFunctions", with_attributes=False)
        )
